...
Please not that only H264 hardware decoding is supported, so you may wish to specify [`&codec=h264`](../advanced-settings/video-parameters/codec.md) in your OBS view links to reduce CPU load.
