...
This chunked mode is similar to the previously released [`&webp`](../viewers-settings/webp.md) broadcast mode, which streamed a series of images as a custom-made video protocol, but the [`&webp`](../viewers-settings/webp.md) has poor compression and quality, and would drop frames if the connection couldn't keep up.
