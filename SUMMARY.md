...
* [Guides](guides/README.md)
  ...
  * [API commands](guides/api-commands/README.md)
    * [audiobitrate](guides/api-commands/audiobitrate.md)
    * [bitrate](guides/api-commands/bitrate.md)
    * [mic](guides/api-commands/mic.md)
    * [volume](guides/api-commands/volume.md)
    * [panning](guides/api-commands/panning.md)
    * [targetBitrate](guides/api-commands/targetbitrate.md)
    * [targetAudioBitrate](guides/api-commands/targetaudiobitrate.md)
    * [mute](guides/api-commands/mute.md)
    * [sendData](guides/api-commands/senddata.md)
    * [sendChat](guides/api-commands/sendchat.md)
    * [keyframe](guides/api-commands/keyframe.md)
    * [changeAudioOutputDevice](guides/api-commands/changeaudiooutputdevice.md)
    * [changeVideoDevice](guides/api-commands/changevideodevice.md)
    * [changeAudioDevice](guides/api-commands/changeaudiodevice.md)
    * [sceneState](guides/api-commands/scenestate.md)
    * [sendMessage](guides/api-commands/sendmessage.md)
    * [sendRawMIDI](guides/api-commands/sendrawmidi.md)
    * [sendPeers](guides/api-commands/sendpeers.md)
    * [reload](guides/api-commands/reload.md)
    * [requestStatsContinuous](guides/api-commands/requeststatscontinuous.md)
    * [getStats](guides/api-commands/getstats.md)
    * [getDeviceList](guides/api-commands/getdevicelist.md)
    * [getRemoteStats](guides/api-commands/getremotestats.md)
    * [getLoudness](guides/api-commands/getloudness.md)
    * [getEffectsData](guides/api-commands/geteffectsdata.md)
    * [getStreamIDs](guides/api-commands/getstreamids.md)
    * [getStreamInfo](guides/api-commands/getstreaminfo.md)
    * [getDetailedState](guides/api-commands/getdetailedstate.md)
    * [close](guides/api-commands/close.md)
    * [style](guides/api-commands/style.md)
    * [automixer](guides/api-commands/automixer.md)
    * [previewMode](guides/api-commands/previewmode.md)
    * [advancedMode](guides/api-commands/advancedmode.md)
    * [requestStream](guides/api-commands/requeststream.md)
    * [scene](guides/api-commands/scene.md)
    * [scale](guides/api-commands/scale.md)
    * [remove](guides/api-commands/remove.md)
    * [settings](guides/api-commands/settings.md)
    * [camera](guides/api-commands/camera.md)
    * [add](guides/api-commands/add.md)
