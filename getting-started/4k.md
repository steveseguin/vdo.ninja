---
description: Getting started guide for 4K in VDO.Ninja with setup steps and practical usage tips.
---
...
VDO.Ninja has three common [`&quality`](../advanced-settings/video-parameters/and-quality.md) levels:
