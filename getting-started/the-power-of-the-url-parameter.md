...
For example, to view the video stream published at stream ID `xxxxxxx` at a video bitrate of 500-kbps and set the [`stereo`](../advanced-settings.md#stereo) parameter to `1`:
