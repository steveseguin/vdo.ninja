...
To use, just download and host the files on a HTTPS-enabled webserver. You may want to hide the .html extensions within your HTTP server as well, else the generated links will not work. See (here)[https://github.com/steveseguin/obsninja/blob/master/install.md] for added details on deploying this repo, although I don't really recommend it in most cases.
