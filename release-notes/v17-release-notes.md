...
If there are problems with version 17, the previous version of OBS.Ninja can still be found at [https://obs.ninja/v164 ](https://obs.ninja/v164)
...
YouTube video talking about the new release a bit: [https://www.youtube.com/watch?v=muZ5BQ1E5Ks](https://www.youtube.com/watch?v=muZ5BQ1E5Ks)
...
*   created a basic chat-overlay based on the VDO.Ninja chat.   [https://obs.ninja/chat?room=asdfasfdsdf](https://obs.ninja/chat?room=asdfasfdsdf)
...
* over 2.5mbps, and the audio bitrate will be around 80kbps inbound, with a 128kbps record bitrate.
...
* Devices page ([https://obs.ninja/devices](https://obs.ninja/devices)) will generate an appropriate \&outputdevice value for URL-based audio output device selection.
...
* The `&tcp` as a flag will force TCP mode _if_ connected to a TURN server, versus the default, which may be UDP or TCP.&#x20;
...
`https://vdo.ninja/speedtest?sid=xxxxxxx` `https://vdo.ninja/monitor?sid=xxxxxxx`
...
[https://github.com/steveseguin/vdo.ninja/wiki/v16.3-update-notes](https://github.com/steveseguin/obsninja/wiki/v16.3-update-notes)

[https://github.com/steveseguin/vdo.ninja/wiki/v16.4-update-notes](https://github.com/steveseguin/obsninja/wiki/v16.4-update-notes)

You can find a list of all previous release notes at [https://github.com/steveseguin/vdo.ninja/wiki/Older-releases](https://github.com/steveseguin/obsninja/wiki/Older-releases)
