...
* Added `&speakermute=false` as an option; this will have the director's mic not start muted. You can use [`&autostart`](../advanced-settings/setup-parameters/and-autostart.md) to auto-select the mic of course, also.
