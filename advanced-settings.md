...
* [settings-parameters](advanced-settings/settings-parameters/ "mention") (language, save cookies, remote access, chunked mode, raise hands, notify, transcription, closed captions)
