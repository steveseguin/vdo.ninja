...
{% content-ref url="../advanced-settings/settings-parameters/and-fullscreenbutton-beta.md" %}
[and-fullscreenbutton-beta.md](../advanced-settings/settings-parameters/and-fullscreenbutton-beta.md)
{% endcontent-ref %}
