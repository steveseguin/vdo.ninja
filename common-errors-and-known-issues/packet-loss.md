...
* If your router or connection supports IPv6, but you don't have it enabled, try enabling it. Sometimes if limiting yourself to IPv4 or IPv6 may be having your ISP send your traffic through an IPv4<>IPv6 translation server, which could introduce delays, throttling, and packet loss.
