...
| --- | --- |
| [`&autowhep`](and-autowhep.md) | Attempts to derive a WHEP share URL from the configured WHIP output URL |
| [`&whepshare`](and-whepshare.md) | Advertises an explicit WHEP source URL to room peers |
| [`&whepsharetoken`](and-whepsharetoken.md) | Adds a bearer token for the advertised WHEP source |
