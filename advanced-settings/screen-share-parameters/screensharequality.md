...
Set a target quality for your screenshare, when you screenshare as a secondary stream (in a room). Use [`&quality`](../../source-settings/quality.md) if you want to set the screenshare quality when only screensharing.
