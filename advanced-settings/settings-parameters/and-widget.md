...
This was designed for Twitch / YouTube / [Social Stream chat](../../steves-helper-apps/social-stream/), but could in theory work with any CORS-friendly site, such as a third-party web tool.
...
{% content-ref url="../../steves-helper-apps/social-stream/" %}
[social-stream](../../steves-helper-apps/social-stream/)
{% endcontent-ref %}
