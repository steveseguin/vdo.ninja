...
You can add `&hash=STRING` this to a guest's URL instead of [`&password`](../general-parameters/password.md) if you want to check the password. That means the password turns into another String.
...
{% content-ref url="../general-parameters/password.md" %}
[password.md](../general-parameters/password.md)
{% endcontent-ref %}
