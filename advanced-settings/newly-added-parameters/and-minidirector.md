...
In the link above, you'll notice the use of [`&css=minidirector.css`](../general-parameters/css.md). You can modify that css file, hosting it yourself locally if you wanted to, allowing you to show which buttons you want. Once all setup, you can add the entire director's room as a dock directly to OBS, and even drag/drop solo links into the show with ease.
