...
You can disable the video and audio of VDO.Ninja, but still have a basic data-only peer-connection, but using `&vd=0&ad=0` or [`&novideo`](../viewers-settings/novideo.md)``[`&noaudio`](../viewers-settings/noaudio.md).
